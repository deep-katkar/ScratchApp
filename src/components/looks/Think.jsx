...
function Think({ character, comp_id }) {
  ...
  return (
    <div>
      <div className="rounded text-center bg-gradient-to-r from-blue-600 to-violet-600 p-2 my-3">
        ...
        <div
          id={comp_id}
          className="flex text-center flex-row flex-wrap bg-purple-900 text-white px-2 py-1 my-2 text-sm cursor-pointer rounded-md"
